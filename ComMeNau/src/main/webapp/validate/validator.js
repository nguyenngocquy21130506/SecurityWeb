...
(function (root) {
    ...
    Protected.prototype = {
        messages: {
            ...
            vi: {
                required: {
                    ...
                    incorrect: 'Giá trị không chính xác'
                },
                notzero: {
                    empty: 'Vui lòng chọn một lựa chọn',
                    incorrect: 'Giá trị không chính xác'
                },
                integer: {
                    empty: 'Nhập một giá trị số nguyên',
                    incorrect: 'Giá trị số nguyên không chính xác'
                },
                float: {
                    empty: 'Nhập một số thực',
                    incorrect: 'Số thực không chính xác'
                },
                min: {
                    empty: 'Nhập nhiều hơn',
                    incorrect: 'Nhập nhiều hơn'
                },
                max: {
                    empty: 'Nhập ít hơn',
                    incorrect: 'Nhập ít hơn'
                },
                between: {
                    empty: 'Nhập giá trị từ {0} đến {1}',
                    incorrect: 'Nhập giá trị từ {0} đến {1}'
                },
                name: {
                    empty: 'Vui lòng nhập tên của bạn',
                    incorrect: 'Tên không chính xác'
                },
                lastname: {
                    empty: 'Vui lòng nhập họ của bạn',
                    incorrect: 'Họ không chính xác'
                },
                phone: {
                    empty: 'Vui lòng nhập số điện thoại',
                    incorrect: 'Số điện thoại không chính xác'
                },
                email: {
                    empty: 'Vui lòng nhập địa chỉ email của bạn',
                    incorrect: 'Địa chỉ email không chính xác'
                },
                length: {
                    empty: 'Vui lòng nhập ít nhất {0} ký tự và tối đa {1} ký tự',
                    incorrect: 'Không chính xác. Nhập ít nhất {0} ký tự và tối đa {1} ký tự'
                },
                minlength: {
                ...
                maxlength: {
                    empty: 'Vui lòng nhập tối đa {0} ký tự',
                    incorrect: 'Bạn đã nhập nhiều hơn {0} ký tự'
                },
                containsWhitespace: {
                    empty: 'Vui lòng nhập trường này',
                    incorrect: "Không được chứa khoảng trắng"
                },
                containsAllWhitespace: {
                    empty: 'Vui lòng nhập trường này',
                    incorrect: "Không hợp lệ"
                },
                maxfilesize: {
                    empty: 'Kích thước của một hoặc nhiều tệp được chọn lớn hơn {0} {1}',
                    incorrect: 'Kích thước của một hoặc nhiều tệp được chọn lớn hơn {0} {1}'
                },
                fileextension: {
                    empty: 'Chọn tệp',
                    incorrect: 'Một hoặc nhiều tệp có loại không hợp lệ'
                },
                formatPass: {
                    incorrect: 'Mật khẩu cần phải chứa ít nhất một chữ hoa, một chữ thường, một ký tự đặc biệt và một số.'
                }
            }
        ...
        rules: {
            ...
            containsAllWhitespace: function (value) {
                return !(/^\s|\s$/.test(value));
            },
            containsWhitespace: function containsWhitespace(value) {
                return !(/\s/.test(value));
            },
            ///(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]/
            containsUpperText: function (value) {
                return /(?=.*[a-z])/.test(value);
            },
            containsLowerText: function (value) {
                return /(?=.*[A-Z])/.test(value);
            },
            ...
            formatPass: function (value) {
                let isValid = true;
                let message = '';
                if (!this.containsUpperText(value)) {
                    message += "ít nhất một ký tự in hoa, ";
                    isValid = false;
                }
                if (!this.containsLowerText(value)) {
                    message += "ít nhất một ký tự in thường, ";
                    isValid = false;
                }
                if (!this.containsNumber(value)) {
                    message += "ít nhất một chữ số, ";
                    isValid = false;
                }
        ...
        showErrors: function (validationField) {
            ...
            if (validationField && validationField.name === 'password') {
                console.log(message)
                insertNodeError(validationField, { errorText: message });
            }
        },
