...
<div class="container-content my-5">
    ...
    <div class="empty py-5 d-flex flex-column align-items-center">
        <div class="d-flex flex-column align-items-center">
            ...
            <span class="empty__text-1">Không có sản phẩm trong danh sách yêu thích của bạn.</span>
            <a class="empty__redirect-link btn--e-brand" href="<c:url value="/home"/>">Quay về trang chủ</a>
        </div>
    </div>
</div>
<!--====== End - App Content ======-->
